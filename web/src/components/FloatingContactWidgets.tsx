...
export function FloatingContactWidgets() {
  ...
  const btnClass =
    "flex h-12 w-12 items-center justify-center rounded-full shadow-lg transition hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-brand-navy";
    ...
    >
      {wa ? (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className={`pointer-events-auto ${btnClass} bg-[#25D366] text-white`}
      ...
      {fb ? (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className={`pointer-events-auto ${btnClass} bg-[#1877F2] text-white`}
